...
def plot_distances(t_on_line,vector_to_line_distances):
...
def plot_distances_min_cleaned(t_on_line, vector_to_line_distances, local_min):
    plt.rcParams['font.size'] = 50
...
def main():
    ...
    with open(json_file_path, "r+") as input_file:
        ...
        plot_distances_min_cleaned(t_on_line, vector_to_line_distances, min_distances)
        plot_distances(t_on_line,vector_to_line_distances)
